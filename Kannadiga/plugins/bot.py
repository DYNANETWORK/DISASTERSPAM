...
KANNADIGA_PIC = ALIVE_PIC if ALIVE_PIC else "https://te.legra.ph/file/541d199b91a724b624712.jpg"
  

DEADLY = "⚡  𝐃𝐈𝐒𝐀𝐒𝐓𝐄𝐑 𝐒𝐏𝐀𝐌𝐁𝐎𝐓 ⚡\n\n"
DEADLY += f" ❤️𝐃𝐈𝐒𝐀𝐒𝐓𝐄𝐑 𝐒𝐏𝐀𝐌𝐁𝐎𝐓❤️\n\n"
DEADLY += f"╔═══════════════════════╗\n"
DEADLY += f"║• **ᴄʀᴇᴀᴛᴏʀ** :` [𝐃𝐈𝐒𝐀𝐒𝐓𝐄𝐑](https://t.me/DISASTER_NETWORK_OWNER)  `             ║\n"
DEADLY += f"║• **ᴛᴇʟᴇᴛʜᴏɴ ᴠᴇʀsɪᴏɴ** : `{version.__version__}`               ║\n"
DEADLY += f"║• **ʙᴏᴛ ᴠᴇʀsɪᴏɴ**  : `{kannadigaversion}` ║\n"
DEADLY += f"╚═══════════════════════╝\n\n"   
...
async def alive(event):
  if event.sender_id in SUDO_USERS:
     await BOT0.send_file(event.chat_id,
                                  ...
                                  buttons=[
        [
        Button.url("❤️ ᴄʜᴀɴɴᴇʟ ❤️", "https://t.me/DISASTER_NETWORK"),
        Button.url("💛 sᴜᴘᴘᴏʀᴛ 💛", "https://t.me/DISASTER_SUPPORT")
        ],
        [
        Button.url("✨ ʀᴇᴘᴏ ✨", "https://github.com/SUKHPAL443/DISASTERSPAMBOT")
        ]
        ]
        )
...
async def ping(e):
    if e.sender_id in SUDO_USERS:
        ...
        await event.edit(f"🎉 𝒫𝐼𝒩𝒢 𝒫𝒪𝒩𝒢 𝒟𝐼𝒮𝒜𝒮𝒯𝐸𝑅 𝐼𝒮 𝒱𝐸𝑅𝒴 𝒪𝒲𝐸𝑅𝐹𝒰𝐿𝐿 𝒮𝒫𝒜𝑀𝐵𝒪𝒯 👅!\n\n♡︎ `{ms}` ᴍs ♡︎")
