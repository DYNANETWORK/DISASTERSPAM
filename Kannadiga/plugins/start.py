...
KANNADIGA_IMG = ALIVE_PIC if ALIVE_PIC else "https://te.legra.ph/file/541d199b91a724b624712.jpg"

Deadly_Button = [
        [
        Button.url("❤️ sᴜᴘᴘᴏʀᴛ ❤️", "https://t.me/DISASTER_SUPPORT")
        ],
        [
        Button.url("💛 ΛႺՕ𝖱Λ 💛", "https://t.me/DISASTER_NETWORK_OWNER")
        ]
        ]
...
DeadlyX_Button = [
        ...
        [
        Button.url("✨ ʀᴇᴘᴏ ✨", "https://github.com/SUKHPAL443/DISASTERSPAM")
        ]
        ]
