...
ZAID_Help = "❤️💛 ∂ιѕαѕтєя ѕραмвσт 💛❤️\n\n"
 
ZAID_Help += f"_ƈƈƈƈƈCʍɖֆ ǟʋǟɨʟǟɮʟɛ ɨռ ɖɨֆǟֆȶɛʀ ֆքǟʍɮօȶֆ_\n\n"
...
async def help(event):               
    if event.sender_id in SUDO_USERS:
      await BOT0.send_file(event.chat_id,
                                  ...
                                  buttons=[
        [
        Button.url("❤️ ᴄʜᴀɴɴᴇʟ ❤️", "https://t.me/DISASTER_SUPPORT")
        ] 
        ]
        )                                                         
