...
OFFICIAL_UPSTREAM_REPO = "https://github.com/SUKHPAL443/DISASTERSPAM"
BOT_IS_UP_TO_DATE = "**The Disaster Robot Spam Bot** is up-to-date sur."
NEW_BOT_UP_DATE_FOUND = (
    "new update found for {branch_name}\n"
    "changelog: \n\n{changelog}\n"
    "updating your Agora Spam Bot..."
)
NEW_UP_DATE_FOUND = "New update found for {branch_name}\n" "`updating your Disaster Robot Spam Bot...`"
...
async def restart(e):
    if e.sender_id == OWNER_ID:
        text = "__U𝗽𝗱𝗮𝘁𝗶𝗻𝗴..... 𝙔𝙊𝙐𝙍 𝘿𝙄𝙎𝘼𝙎𝙏𝙀𝙍 𝙎𝙋𝘼𝙈 𝘽𝙊𝙏__\n𝗧𝘆𝗽𝗲 .ping 𝗔𝗳𝘁𝗲𝗿 5𝗺𝗶𝗻𝘀 𝗧𝗼 𝗖𝗵𝗲𝗰𝗸 𝗜'𝗺 𝗼𝗻 !!"
...
async def deploy_start(SAM, message, refspec, remote):
    ...
    await message.edit(
        "Updated Your Disaster Robot Spam Bot successfully sur!!!\n© @DISASTER_NETWORK"
    )
